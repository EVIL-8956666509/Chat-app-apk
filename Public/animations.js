...
class AnimationSystem {
    ...
    initStars() {
        for (let i = 0; i < 150; i++) {
            this.stars.push({
                ...
                color: ['#ffffff', '#ffe4e1', '#ffd700', '#ff69b4'][Math.floor(Math.random() * 4)]
            });
        }
    }
    ...
    createHeart() {
        return {
            ...
            color: ['#ff6b9d', '#ff8fab', '#ffc2d1', '#ff1744'][Math.floor(Math.random() * 4)],
    ...
    createParticle() {
        return {
            ...
            color: ['#ffffff', '#fffacd', '#ffe4e1', '#e6e6fa'][Math.floor(Math.random() * 4)]
        };
    }
